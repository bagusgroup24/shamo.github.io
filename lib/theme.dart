...
Color backgorundColor1 = Color(0xff1F1D2B);
Color backgorundColor2 = Color(0xff2B2937);
Color backgorundColor3 = Color(0xff242231);
Color backgorundColor4 = Color(0xff252836);
Color backgorundColor5 = Color(0xff2B2844);
Color backgorundColor6 = Color(0xffECEDEF);
